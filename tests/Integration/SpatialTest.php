...
use Elattar\LaravelMysqlSpatial\Types\GeometryCollection;
use Elattar\LaravelMysqlSpatial\Types\LineString;
use Elattar\LaravelMysqlSpatial\Types\MultiPoint;
use Elattar\LaravelMysqlSpatial\Types\MultiPolygon;
...
class SpatialTest extends IntegrationBaseTestCase
{
    ...
    public function testSpatialFieldsNotDefinedException()
    {
        ...
        $this->assertException(\Elattar\LaravelMysqlSpatial\Exceptions\SpatialFieldsNotDefinedException::class);
    ...
    public function testOrderBySpatialWithUnknownFunction()
    {
        ...
        $this->assertException(\Elattar\LaravelMysqlSpatial\Exceptions\UnknownSpatialFunctionException::class);
    ...
    //    $point = new Point(0, 0);
    //
    //    $linestring1 = \Elattar\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(1 1, 2 2)");
    //    $linestring2 = \Elattar\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(20 20, 24 24)");
    //    $linestring3 = \Elattar\LaravelMysqlSpatial\Types\LineString::fromWkt("LINESTRING(0 10, 10 10)");
    //
