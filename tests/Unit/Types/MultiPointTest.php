...
class MultiPointTest extends BaseTestCase
{
    ...
    public function testInvalidArgumentExceptionAtLeastOneEntry()
    {
        $this->assertException(
            ...
            'Elattar\LaravelMysqlSpatial\Types\MultiPoint must contain at least 1 entry'
        );
    ...
    public function testInvalidArgumentExceptionNotArrayOfLineString()
    {
        $this->assertException(
            InvalidArgumentException::class,
            'Elattar\LaravelMysqlSpatial\Types\MultiPoint must be a collection of Elattar\LaravelMysqlSpatial\Types\Point'
        );
        $multipoint = new MultiPoint([
            new Point(0, 0),
            1,
