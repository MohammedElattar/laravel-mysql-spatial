...
use Elattar\LaravelMysqlSpatial\Types\MultiLineString;
...
class MultiLineStringTest extends BaseTestCase
{
    ...
    public function testInvalidGeoJsonException()
    {
        $this->assertException(
            \Elattar\LaravelMysqlSpatial\Exceptions\InvalidGeoJsonException::class,
    ...
    public function testInvalidArgumentExceptionAtLeastOneEntry()
    {
        $this->assertException(
            ...
            'Elattar\LaravelMysqlSpatial\Types\MultiLineString must contain at least 1 entry'
        );
    ...
    public function testInvalidArgumentExceptionNotArrayOfLineString()
    {
        $this->assertException(
            InvalidArgumentException::class,
            'Elattar\LaravelMysqlSpatial\Types\MultiLineString must be a collection of Elattar\LaravelMysqlSpatial\Types\LineString'
        );
        $multilinestring = new MultiLineString([
