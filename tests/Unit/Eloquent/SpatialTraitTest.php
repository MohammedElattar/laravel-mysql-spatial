...
class SpatialTraitTest extends BaseTestCase
{
    ...
    public function testInsertUpdateLineStringHasCorrectSql()
    {
        ...
        $this->model->linestring = new \Elattar\LaravelMysqlSpatial\Types\LineString([$point1, $point2]);
        $this->model->save();
    ...
    public function testInsertUpdatePolygonHasCorrectSql()
    {
        $point1 = new Point(1, 2);
        $point2 = new Point(2, 3);
        $linestring1 = new \Elattar\LaravelMysqlSpatial\Types\LineString([$point1, $point2]);
        $point3 = new Point(3, 2);
        $point4 = new Point(2, 1);
        $linestring2 = new \Elattar\LaravelMysqlSpatial\Types\LineString([$point3, $point4]);

        $this->assertFalse($this->model->exists);

        $this->model->polygon = new \Elattar\LaravelMysqlSpatial\Types\Polygon([$linestring1, $linestring2]);
        $this->model->save();
    ...
    public function testInsertUpdateMultiPointHasCorrectSql()
    {
        ...
        $this->model->multipoint = new \Elattar\LaravelMysqlSpatial\Types\MultiPoint([$point1, $point2]);
        $this->model->save();
    ...
    public function testInsertUpdateMultiLineStringHasCorrectSql()
    {
        ...
        $this->model->multilinestring = new \Elattar\LaravelMysqlSpatial\Types\MultiLineString([$linestring1, $linestring2]);
        $this->model->save();
    ...
    public function testInsertUpdateMultiPolygonHasCorrectSql()
    {
        ...
        $point4 = new Point(2, 1);
        $linestring2 = new \Elattar\LaravelMysqlSpatial\Types\LineString([$point3, $point4]);
        $polygon1 = new \Elattar\LaravelMysqlSpatial\Types\Polygon([$linestring1, $linestring2]);

        $point5 = new Point(4, 5);
        $point6 = new Point(5, 6);
        $linestring3 = new \Elattar\LaravelMysqlSpatial\Types\LineString([$point5, $point6]);
        $point7 = new Point(6, 5);
        $point8 = new Point(5, 4);
        $linestring4 = new \Elattar\LaravelMysqlSpatial\Types\LineString([$point7, $point8]);
        $polygon2 = new \Elattar\LaravelMysqlSpatial\Types\Polygon([$linestring3, $linestring4]);

        $this->assertFalse($this->model->exists);

        $this->model->multipolygon = new \Elattar\LaravelMysqlSpatial\Types\MultiPolygon([$polygon1, $polygon2]);
        $this->model->save();
    ...
    public function testInsertUpdateGeometryCollectionHasCorrectSql()
    {
        ...
        $linestring1 = new \Elattar\LaravelMysqlSpatial\Types\LineString([$point2, $point3]);

        $this->assertFalse($this->model->exists);

        $this->model->geometrycollection = new \Elattar\LaravelMysqlSpatial\Types\GeometryCollection([$point1, $linestring1]);
        $this->model->save();
    ...
    public function testScopeDistance()
    {
        ...
        $this->assertInstanceOf(\Elattar\LaravelMysqlSpatial\Eloquent\Builder::class, $query);
        $q = $query->getQuery();
    ...
    private function buildTestPolygon()
    {
        ...
        return new \Elattar\LaravelMysqlSpatial\Types\Polygon([$linestring1, $linestring2, $linestring3]);
    }
    ...
    public function testScopeOrderBySpatialThrowsExceptionWhenFunctionNotRegistered()
    {
        $point = new Point(1, 2);
        $this->assertException(
            \Elattar\LaravelMysqlSpatial\Exceptions\UnknownSpatialFunctionException::class,
            'does-not-exist'
        );
