...
[![Build Status](https://img.shields.io/travis/Elattar/laravel-mysql-spatial.svg?style=flat-square)](https://travis-ci.org/Elattar/laravel-mysql-spatial)
[![Code Climate](https://img.shields.io/codeclimate/maintainability/Elattar/laravel-mysql-spatial.svg?style=flat-square)](https://codeclimate.com/github/Elattar/laravel-mysql-spatial/maintainability)
[![Code Climate](https://img.shields.io/codeclimate/c/Elattar/laravel-mysql-spatial.svg?style=flat-square&colorB=4BCA2A)](https://codeclimate.com/github/Elattar/laravel-mysql-spatial/test_coverage) [![Packagist](https://img.shields.io/packagist/v/Elattar/laravel-mysql-spatial.svg?style=flat-square)](https://packagist.org/packages/Elattar/laravel-mysql-spatial)
[![Packagist](https://img.shields.io/packagist/dt/Elattar/laravel-mysql-spatial.svg?style=flat-square)](https://packagist.org/packages/Elattar/laravel-mysql-spatial) [![StyleCI](https://github.styleci.io/repos/83766141/shield?branch=master)](https://github.styleci.io/repos/83766141) 
...
```sh
$ composer require elattar/laravel-mysql-spatial:^4.0

# or for Laravel version < 8.0
$ composer require elattar/laravel-mysql-spatial:^3.0
```

For MySQL 5.7:

```shell
$ composer require elattar/laravel-mysql-spatial:^2.0
```

For MySQL 5.6 and 5.5:

```shell
$ composer require elattar/laravel-mysql-spatial:^1.0
```
...
'providers' => [
   ...
   */
  Elattar\LaravelMysqlSpatial\SpatialServiceProvider::class,
],
```
...
Then edit the migration you just created by adding at least one spatial data field. For Laravel versions prior to 5.5, you can use the Blueprint provided by this package (Elattar\LaravelMysqlSpatial\Schema\Blueprint):
...
// For Laravel < 5.5
// use Elattar\LaravelMysqlSpatial\Schema\Blueprint;
 ...
 * @property \Elattar\LaravelMysqlSpatial\Types\Polygon $area
 */
...
| Elattar\LaravelMysqlSpatial\Types                             | OpenGIS Class                                                |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
...
In order for your Eloquent Model to handle the Geometry classes, it must use the `Elattar\LaravelMysqlSpatial\Eloquent\SpatialTrait` trait and define a `protected` property `$spatialFields`  as an array of MySQL Spatial Data Type column names (example in [Quickstart](#user-content-create-a-model)).
...
For Laravel versions prior to 5.5, you can use the Blueprint provided with this package: `Elattar\LaravelMysqlSpatial\Schema\Blueprint`.
